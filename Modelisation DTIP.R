...
setwd("C:/Users/Colombine/Desktop/GIMAT/Cours/Module 3 STATEPI/R")
library(prettyR)
library(psych)
library(dplyr)
library(mgcv)
...
hist(CV$PARITE,xlab="Parite des meres",main="Representation de la parité")
...
Tbr
barplot(Tbr,beside=T,legend=levels(unique(CVC$DTIP)),main="Parité et deficit",xlab="Parite",ylab="effectif")
comp<-chisq.test(Tbr)
chisq.test(Tbr)
comp$expected
...
boxplot(CVC$BU1_VOL~CVC$DTIP,xlab="Deficit",ylab="Volume",main="Volume de colostrum et déficit")
...
par(mfrow=c(1,2))
boxplot(CVC$COL_IGG~CVC$DTIP,xlab="Deficit",ylab="Concentration",main="Concentration IgG et déficit")
...
xplot(CVC$MIGG1~CVC$DTIP,xlab="Deficit",ylab="MASSE",main="Masse IgG et déficit")
